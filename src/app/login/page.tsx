      ...
      <div className="flex w-full lg:w-[40%] items-center justify-center bg-white px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            ...
            <button
              type="button"
              className="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white py-2.5 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 transition-all"
            >
