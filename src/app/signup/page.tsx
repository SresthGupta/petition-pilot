  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (authError) {
        ...
        // Redirect to dashboard (email confirmation is disabled, user is auto-signed in)
        ...
        <div className="w-full max-w-md">
          ...
          {emailSent ? (
            <div className="text-center py-8">
              ...
              <Link
                href="/login"
                className="mt-8 inline-flex items-center justify-center rounded-lg bg-indigo-600 px-6 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-700 transition-all"
              >
                Back to Sign In
              </Link>
            </div>
